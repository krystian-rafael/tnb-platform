...
public class UserServiceIntegrationTest {
    ...
    public void testUpdateUser() {
        ...
        UserData updatedData = new UserData(createdUser.getId(), "krystian", "newPassword1234", false, "fr", LocalDateTime.now(), null);
        UserData updatedUser = userService.updateUser(createdUser.getId(), updatedData);

        assertThat(updatedUser.getLogin()).isEqualTo("krystian");
        assertThat(updatedUser.getPassword()).isEqualTo("newPassword1234");
